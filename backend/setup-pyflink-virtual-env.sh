...
if [[ ${sys_os} == "Darwin" ]]; then
    wget "https://repo.anaconda.com/miniconda/Miniconda3-py38_23.5.2-0-MacOSX-${sys_machine}.sh" -O "miniconda.sh"
elif [[ ${sys_os} == "Linux" ]]; then
    wget "https://repo.anaconda.com/miniconda/Miniconda3-py38_23.5.2-0-Linux-${sys_machine}.sh" -O "miniconda.sh"
else
...
./miniconda.sh -b -p venv python=3.8
